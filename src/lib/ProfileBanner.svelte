...
<div class="bg-gray-300">
  ...
  <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="-mt-12 sm:-mt-16 sm:flex sm:items-end sm:space-x-5">
      <div class="flex">
        <img class="h-24 w-24 bg-gradient-to-tr from-blue-400 to-blue-800 ring-gray-800 ring-1 rounded-full object-cover sm:h-32 sm:w-32" src="./static/portrait.png" alt="" />
      </div>
      <div class="mt-6 sm:flex-1 sm:min-w-0 sm:flex sm:items-center sm:justify-end sm:space-x-6 sm:pb-1">
        <div class="sm:hidden md:block mt-6 min-w-0 flex-1">
          <h1 class="text-2xl font-bold text-gray-500 truncate">Jack Clayton</h1>
        </div>
